...
/*	if (verbose) {
	...
	*/
	...
	fprintf(out,"Dst IP\t");
	fprintf(out,"Proto\t");
	fprintf(out,"Src port\t");
	fprintf(out,"Dst port\t");
	fprintf(out,"Iface_in\t");
	fprintf(out,"Iface_out\t");
	fprintf(out,"First seen (->)\t");
	fprintf(out,"First seen (<-)\t");
	fprintf(out,"Last seen (->)\t");
	fprintf(out,"Last seen (<-)\t");
	fprintf(out,"Jitter cum. (->)\t");
	fprintf(out,"Jitter cum. (<-)\t");
	fprintf(out,"Pkts (->)\t");
	fprintf(out,"Pkts (<-)\t");
	fprintf(out,"IP Vers. (->)\t");
	fprintf(out,"IP Vers. (<-)\t");
	fprintf(out,"Flow label (->)\t");
	fprintf(out,"Flow label (<-)\t");
	fprintf(out,"TOS (->)\t");
	fprintf(out,"TOS (<-)\t");
	fprintf(out,"Bytes (->)\t");
	fprintf(out,"Bytes (<-)\t");
	fprintf(out,"Min pkt len (->)\t");
	fprintf(out,"Min pkt len (<-)\t");
	fprintf(out,"Max pkt len (->)\t");
	fprintf(out,"Max pkt len (<-)\t");
	fprintf(out,"Pkts 0-127  (->)\t");
	fprintf(out,"Pkts 128-255  (->)\t");
	fprintf(out,"Pkts 255-511  (->)\t");
	fprintf(out,"Pkts 512-1023  (->)\t");
	fprintf(out,"Pkts 1024-1513  (->)\t");
	fprintf(out,"Pkts 1514  (->)\t");
	fprintf(out,"Pkts 0-127  (<-)\t");
	fprintf(out,"Pkts 128-255  (<-)\t");
	fprintf(out,"Pkts 255-511  (<-)\t");
	fprintf(out,"Pkts 512-1023  (<-)\t");
	...
	fprintf(out,"TTL 1 (->)\t");
	fprintf(out,"TTL 2-5 (->)\t");
	fprintf(out,"TTL 6-32 (->)\t");
	fprintf(out,"TTL 33-64 (->)\t");
	fprintf(out,"TTL 65-96 (->)\t");
	fprintf(out,"TTL 97-128 (->)\t");
	fprintf(out,"TTL 129-192 (->)\t");
	fprintf(out,"TTL 193-224 (->)\t");
	fprintf(out,"TTL 225-255 (->)\t");
	fprintf(out,"TTL 1 (<-)\t");
	fprintf(out,"TTL 2-5 (<-)\t");
	fprintf(out,"TTL 6-32 (<-)\t");
	fprintf(out,"TTL 33-64 (<-)\t");
	...
	fprintf(out,"TCP flags (<-)\t");
	fprintf(out,"TCP retr. pkts (->)\t");
	fprintf(out,"TCP retr. pkts (<-)\t");
	fprintf(out,"TCP retr. bytes (->)\t");
	fprintf(out,"TCP retr. bytes (<-)\t");
	fprintf(out,"TCP ooo pkts (->)\t");
	fprintf(out,"TCP ooo pkts (<-)\t");
	fprintf(out,"TCP ooo bytes (->)\t");
	fprintf(out,"TCP ooo bytes (<-)\t");
	fprintf(out,"TCP min win (->)\t");
	fprintf(out,"TCP min win (<-)\t");
	fprintf(out,"TCP max win (->)\t");
	fprintf(out,"TCP max win (<-)\t");
	fprintf(out,"TCP mss (->)\t");
	fprintf(out,"TCP mss (<-)\t");
	fprintf(out,"TCP wndw scale (->)\t");
	fprintf(out,"TCP wndw scale (<-)\t");
	fprintf(out,"\n");
